    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div>
            ...
            <p class="text-secondary-vital mb-0">
                Modifica la información de la cita seleccionada.
            </p>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        ...
                        <div class="text-md-end">
                            ...
                            <small class="text-secondary-vital d-block">
                                Registrada
                            </small>
                                    ...
                                    >
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <input
                                                ...
                                                id="tipo_asistir"
                                                value="asistir_cita"
                                                {{ $tipoActual === 'asistir_cita' ? 'checked' : '' }}
                                                required
                                            >
                                    ...
                                    >
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <input
                                                ...
                                                {{ $tipoActual === 'recoger_medicamentos' ? 'checked' : '' }}
                                                required
                                            >
                                            ...
                                            <div>
                                                ...
                                                <small class="text-secondary-vital">
                                                    Programar el recojo de medicamentos.
                                                </small>
