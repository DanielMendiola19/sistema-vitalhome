...
<div class="container-fluid py-4">
    <div class="mb-4">
        ...
        <h1 class="fw-bold mt-3 mb-1" style="color:#0f172a;">Registrar medicamento</h1>
        <p class="text-muted mb-0">Registra un nuevo medicamento en el catálogo.</p>
    </div>
    ...
    <div class="card medicine-form-card">
        <div class="card-body p-4">
            ...
            <form id="medicamentoForm" method="POST" action="{{ route('medicamentos.store') }}" novalidate>
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                        <label for="nombre" class="form-label">Nombre *</label>
                        <input id="nombre" type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre') }}" maxlength="150" required>
                        <div class="field-message" data-message-for="nombre"></div>
                    </div>
                    <div class="col-md-6">
                        <label for="principio_activo" class="form-label">Principio activo</label>
                        <input id="principio_activo" type="text" name="principio_activo" class="form-control @error('principio_activo') is-invalid @enderror" value="{{ old('principio_activo') }}" maxlength="150">
                        <div class="field-message" data-message-for="principio_activo"></div>
                    </div>
                    <div class="col-md-4">
                        <label for="presentacion" class="form-label">Presentación *</label>
                        <input id="presentacion" type="text" name="presentacion" class="form-control @error('presentacion') is-invalid @enderror" placeholder="Ej. Tableta" value="{{ old('presentacion') }}" maxlength="100" required>
                        <div class="field-message" data-message-for="presentacion"></div>
                    </div>
                    <div class="col-md-4">
                        <label for="concentracion" class="form-label">Concentración</label>
                        <input id="concentracion" type="text" name="concentracion" class="form-control @error('concentracion') is-invalid @enderror" placeholder="Ej. 500" value="{{ old('concentracion') }}" maxlength="100">
                        <div class="field-message" data-message-for="concentracion"></div>
                    </div>
                    <div class="col-md-4">
                        <label for="unidad_medida" class="form-label">Unidad de medida</label>
                        <input id="unidad_medida" type="text" name="unidad_medida" class="form-control @error('unidad_medida') is-invalid @enderror" placeholder="Ej. mg" value="{{ old('unidad_medida') }}" maxlength="50">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-end gap-2 mt-4">
                    ...
                    <button id="submitButton" type="submit" class="btn btn-success">Registrar medicamento</button>
                </div>
            </form>
        </div>
    </div>
